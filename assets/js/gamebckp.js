    ...
    update: function() {
      $.each(this.moving, function(index, result) {
        if(result.state == true) {
          // if(that.player.facing.length == 0) {
          //   that.player.facing += index;
          // } else {
          //   that.player.facing += ` ${index}`;
          // }
          ...
          if(is_moving == true) {
            ...
            id = that.player.facing.length;
            that.player.character.sprite.sx = that.player.character.sprite.animations[index][that.player.step].sx;
            that.player.character.sprite.sy = that.player.character.sprite.animations[index][that.player.step].sy;
            that.player.footsteps();
          } else {
            that.player.character.sprite.sx = that.player.character.sprite.animations[index][2].sx;
            that.player.character.sprite.sy = that.player.character.sprite.animations[index][2].sy;
          }
        }
      });
